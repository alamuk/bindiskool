...
export const metadata: Metadata = {
  ...
  description:
    "BirdiSkool Core CRM - Complete practice management system with automation, booking, follow-ups, and dashboards. Join the waitlist for founder pricing at £295/month.",
};
...
export default function CRMPage() {
  return (
    <div className="min-h-screen bg-white">
      ...
      <main>
        {/* Hero Section */}
        <section className="py-20 bg-linear-to-br from-brand-emerald to-green-600">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="max-w-4xl mx-auto text-center">
              ...
              <div className="text-center mb-8">
                <span className="font-playfair text-5xl md:text-6xl font-bold text-white">
                  £295
                </span>
                <span className="text-xl ml-2 text-white/80">/month</span>
                <p className="text-lg mt-2 text-white/80">
                  Founder's early access pricing
                </p>
              </div>
            ...
            <div className="max-w-4xl mx-auto">
              ...
              <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 mb-16">
                <div className="text-center">
                  ...
                  <h3 className="font-montserrat text-xl font-semibold text-brand-indigo mb-4">
                    Smart Automation
                  </h3>
                  <p className="text-brand-slate">
                    Automate patient journeys, follow-ups, and administrative
                    tasks while maintaining personal touch.
                  </p>
                </div>
                ...
                <div className="text-center">
                  ...
                  <p className="text-brand-slate">
                    Seamless online booking with compliance features, automated
                    confirmations, and intelligent scheduling.
                  </p>
                </div>
                ...
                <div className="text-center">
                  ...
                  <p className="text-brand-slate">
                    Real-time insights into practice performance, patient
